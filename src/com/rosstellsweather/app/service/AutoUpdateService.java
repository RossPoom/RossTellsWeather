package com.rosstellsweather.app.service;


import com.rosstellsweather.app.receiver.AutoUpdateReceiver;
	...
	protected void updateWeather() {
		...
		HttpUtil.sendHttpRequest(address, new HttpCallBackListener() {
			...
			public void onFinish(String response) {
				DataParseUtility.handleWeatherResponse(AutoUpdateService.this,
						response);
			}
